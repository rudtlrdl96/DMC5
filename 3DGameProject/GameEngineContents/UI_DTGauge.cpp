...
void UI_DTGauge::Start()
{
	...
	for (int i = 0; i < 3; i++)
	{
		DTGauges.push_back(UIFBXActorBase::CreateGaugeBar({ -590.0f + i * 16.0f , 372.0f , 30.0f }, { 0.9f, 0.9f, 0.9f }, { -90.0f,0.0f,0.0f }, "DtGauge.FBX"));
	}
	for (int i = 0; i < 7; i++)
	{
		DTGauges.push_back(UIFBXActorBase::CreateGaugeBar({ -541.0f + i * 13.0f , 375.0f , 30.0f }, { 0.7f, 0.7f, 0.7f }, { -90.0f,0.0f,0.0f }, "DtGauge.FBX"));
	}
}
...
{
	DTGauges[DTIndex]->SetMulColor({ 0.7f,0.588f,0.925f,1.0f });
}
