...
float4 FXAA_PS(OutPut _Value) : SV_Target0
{
    ...
    Tex,
    Tex,
    float2(1.0f / ScreenScale.x, 1.0f / ScreenScale.y),
    float4(-0.33f / ScreenScale.x, -0.33f / ScreenScale.y, 0.33f / ScreenScale.x, 0.33f / ScreenScale.y),
    float4(-2.0f / ScreenScale.x, -2.0f / ScreenScale.y, 2.0f / ScreenScale.x, 2.0f / ScreenScale.y),
    float4(8.0f / ScreenScale.x, 8.0f / ScreenScale.y, -4.0f / ScreenScale.x, -4.0f / ScreenScale.y),
    0.75f,
    0.125f,
    0.0625f,
    8.0f,
