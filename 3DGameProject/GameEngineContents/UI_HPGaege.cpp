...
void UI_HPGaege::Start()
{
	...
	NeroHpAni->GetTransform()->SetLocalPosition({ -240.0f,944.0f,50.0f });
	...
	NeroHPUI_Front->GetTransform()->SetLocalPosition({ -350.0f,404.8f,40.0f });
	...
	NeroHPUI_Back->GetTransform()->SetLocalPosition({ -350.0f,404.8f,50.0f });
	for (int i = 0; i < 10; i++)
	{
